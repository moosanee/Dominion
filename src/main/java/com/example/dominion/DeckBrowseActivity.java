...
public class DeckBrowseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pileCardData = (ArrayList<CardData>) getIntent().getSerializableExtra
                ("deckPileListKey");
        setContentView(R.layout.activity_deck_browse);

        LinearLayout deckPileLayout = (LinearLayout) findViewById(R.id.deck_pile_layout);
        LinearLayout deckCardLayout = (LinearLayout) findViewById(R.id.deck_card_layout);
        ...
        if (pileCardData.size() == 0){
            ...
            deckCardLayout.addView(noCardsText);
            cardChosen = false;
        }
        else {
            ...
            for (int i = 0; i < pileCardData.size(); i++){
                ...
                deckPileLayout.addView(newCardLayout);
                // create card image
    ...
    void setButtonListeners(){
        ...
        Button exitButton = findViewById(R.id.exit_deck_browse);
